"""test_retro_editorial.py - Visual approval gate test for Template 4: Modern Editorial."""
import unittest
...
class TestRetroEditorialVisualGate(unittest.TestCase):
    def test_retro_editorial_visual_gate(self):
        ...
        (artifact_dir / "retro_editorial_rendered.html").write_text(html, encoding="utf-8")
        ...
        with sync_playwright() as p:
            ...
            # Assert Hero Video & Screen exist inside section.retro-hero
            ...
            # Assert video source contains pexels download link or fallback
            ...
            # Assert video is positioned absolutely inside screen
